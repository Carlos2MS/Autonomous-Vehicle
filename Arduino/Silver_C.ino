  ...
  if (client.available()){
    ...
    //'U' equal to GUI Silver
      ...
      while (true) {
        ...
        // Read Speed
        String speedString = client.readStringUntil('\n'); // Read the string until newline character
        UserSpeed = speedString.toInt(); // Convert the string to an integer
